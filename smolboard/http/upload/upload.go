...
import (
	...
	"github.com/diamondburned/smolboard/smolboard/http/upload/atomdl"
...
func (c UploadConfig) CreatePosts(headers []*multipart.FileHeader) ([]*db.Post, error) {
	if len(headers) > MaxFiles {
		return nil, ErrTooManyFiles
	}

	var posts = make([]*db.Post, len(headers))
...
func (c UploadConfig) createPost(header *multipart.FileHeader) (*db.Post, error) {
	// Fast path.
